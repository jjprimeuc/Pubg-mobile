...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || 'malik',
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_0272_b47e_71a7_bd31_d352_2cfb_532e_ce5b',
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '𝐌-𝐌𝐀𝐋𝐈𝐊-𝐊𝐇𝐀𝐍-𝐌𝐃'',
  ...
  STATUS_REACTION_EMOJI: process.env.STATUS_REACTION_EMOJI || "M-MALIK-KHAN-MD'",
