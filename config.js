...
module.exports = {
  ...
  CONTEXTINFO: process.env.CONTEXTINFO || `{"title": "PUBG-ᴍᴅ", "body": "ᴀᴡᴇꜱᴏᴍᴇ 🤫", "thumbnailUrl": "https://cdn.ironman.my.id/q/gHRsu.jpg", "renderLargerThumbnail": false, "mediaType": 1, "mediaUrl": "", "sourceUrl": "https://github.com/jjprimeuc/Pubg-mobile", "showAdAttribution": true}`,
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'PuBG;ᴡᴀʙᴏᴛ',
  ...
  GOODBYE_MSG: process.env.GOODBYE_MSG || "Hi $mention DON'T COME BACK",
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ʟɪꜱᴛ ᴍᴇɴᴜ;PUBG-ᴍᴅ;https://cdn.ironman.my.id/q/gHRsu.jpg',
  ...
  STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "*UP FOR PUBG😘✨*",
  ...
  BOT_INFO: process.env.BOT_INFO || 'PUBG;JEOL-PRIME;https://cdn.ironman.my.id/q/gHRsu.jpg',
